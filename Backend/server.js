...
app.use(cors({
  origin: [
    'http://13.60.236.63:8221', // Login Server
    'http://13.60.236.63:3055', // Employee Server
    'http://13.60.236.63:5500', // Live Server (Default)
    'http://127.0.0.1:5500', // Live Server (IP)
   // 'http://13.60.236.63:8222'  // Live Server (Alternate)
  ]
}));
